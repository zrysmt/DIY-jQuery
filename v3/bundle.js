...
jQuery$1.extend({
    ...
    type: function type(obj) {
        ...
        class2type[toString.call(obj)] || "object" : typeof obj === 'undefined' ? 'undefined' : _typeof(obj);
    },
...
jQuery$1.fn.extend({
    find: function find(selector) {
        ...
        for (i = 0; i < len; i++) {
            jQuery$1.find(selector, self[i], ret); // //直接利用 Sizzle 接口，把结果注入到 ret 数组中去
        }
...
var selectorInit$1 = function selectorInit$1(jQuery) {
